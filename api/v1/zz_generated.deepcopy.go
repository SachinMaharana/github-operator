...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RepoOptions) DeepCopyInto(out *RepoOptions) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RepoOptions.
func (in *RepoOptions) DeepCopy() *RepoOptions {
	if in == nil {
		return nil
	}
	out := new(RepoOptions)
